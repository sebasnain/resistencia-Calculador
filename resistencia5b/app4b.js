...
let seleccionador5 = document.getElementById("seleccionador5");
...
let banda5Color = document.getElementById("banda-5");
...
const coloresBanda = {
  ...
  seleccionador5.addEventListener("change", function() {
      banda5Color.style.backgroundColor = coloresBanda[this.value];
      });
...
botonCalcular.addEventListener("click", function() {
    let selec1 = seleccionador1.value 
    let selec2 = seleccionador2.value 
    let selec3 = seleccionador3.value
    let multiplicador = multiBanda[seleccionador4.value]
    let selec4 = Number(multiplicador)
   valorPorCodigo(selec1 ,selec2 ,selec3 , selec4)

   
});


function valorPorCodigo(numeroBanda1 ,numeroBanda2 ,numeroBanda3 , numeroBanda4){
 
    let resultado1 = numeroBanda1 + numeroBanda2 + numeroBanda3  ;
    console.log( 'la concatenacion es:' +  resultado1)
    let resultado2 = Number(resultado1)
    let resultado3 = resultado2 * numeroBanda4;
